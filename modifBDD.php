	...
	<body>
		...
		try{
			...
			$dbco = new PDO ('mysql:host=localhost;dbname=test','root', '');
			   ...
			   $sth = $dbco->prepare("
			   UPDATE testtable 
			   SET pays='$pays' , ville1='$ville1' , duree='$duree' , dureeConvert='$dureeConvert' , detailAchat='$detailAchat' , unite='$unite' , distance='$distance' , listeActivitees1='$listeActivitees1' , listeActivitees2='$listeActivitees2'  ,
